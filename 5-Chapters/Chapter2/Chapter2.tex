...
\begin{figure}[h]
	\centering
	\includegraphics[angle=90,width=0.5\textheight,keepaspectratio]{5-Chapters/Chapter2/diagrams/Class Diagram.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1\linewidth]{5-Chapters/Chapter2/diagrams/Entity-Relation.png}
...
% ! A Ajouter ici soit un description soit enelever tout ca
...
\begin{figure}[h]
	\centering
    \includegraphics[width=\linewidth,height=0.9\textheight,keepaspectratio]{5-Chapters/Chapter2/diagrams/Architecture Global.png}
